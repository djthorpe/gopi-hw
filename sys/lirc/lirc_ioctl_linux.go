...
func (this *lirc) getFeatures() (lirc_feature, error) {
	...
	if err := this.lirc_ioctl(this.dev_in.Fd(), LIRC_GET_FEATURES, unsafe.Pointer(&features)); err != 0 {
...
func (this *lirc) getSendMode() (gopi.LIRCMode, error) {
	...
	if err := this.lirc_ioctl(this.dev_in.Fd(), LIRC_GET_SEND_MODE, unsafe.Pointer(&value)); err != 0 {
...
func (this *lirc) setSendMode(value gopi.LIRCMode) error {
	if err := this.lirc_ioctl(this.dev_in.Fd(), LIRC_SET_SEND_MODE, unsafe.Pointer(&value)); err != 0 {
...
func (this *lirc) getRcvMode() (gopi.LIRCMode, error) {
	var value gopi.LIRCMode
	if err := this.lirc_ioctl(this.dev_in.Fd(), LIRC_GET_REC_MODE, unsafe.Pointer(&value)); err != 0 {
...
func (this *lirc) setRcvMode(value gopi.LIRCMode) error {
	if err := this.lirc_ioctl(this.dev_in.Fd(), LIRC_SET_REC_MODE, unsafe.Pointer(&value)); err != 0 {
...
func (this *lirc) getRcvResolutionMicros() (uint32, error) {
	var value uint32
	if err := this.lirc_ioctl(this.dev_in.Fd(), LIRC_GET_REC_RESOLUTION, unsafe.Pointer(&value)); err != 0 {
...
func (this *lirc) getMinMaxTimeoutMicros() (uint32, uint32, error) {
	var min, max uint32
	if err := this.lirc_ioctl(this.dev_in.Fd(), LIRC_GET_MIN_TIMEOUT, unsafe.Pointer(&min)); err != 0 {
		return 0, 0, os.NewSyscallError("getMinMaxTimeoutMicros", err)
	}
	if err := this.lirc_ioctl(this.dev_in.Fd(), LIRC_GET_MAX_TIMEOUT, unsafe.Pointer(&max)); err != 0 {
		return 0, 0, os.NewSyscallError("getMinMaxTimeoutMicros", err)
	}
	return min, max, nil
}
...
func (this *lirc) setRcvTimeoutMicros(value uint32) error {
	if err := this.lirc_ioctl(this.dev_in.Fd(), LIRC_SET_REC_TIMEOUT, unsafe.Pointer(&value)); err != 0 {
...
func (this *lirc) getLength() (uint32, error) {
	var value uint32
	if err := this.lirc_ioctl(this.dev_in.Fd(), LIRC_GET_LENGTH, unsafe.Pointer(&value)); err != 0 {
...
func (this *lirc) setRcvCarrierHz(value uint32) error {
	if err := this.lirc_ioctl(this.dev_in.Fd(), LIRC_SET_REC_CARRIER, unsafe.Pointer(&value)); err != 0 {
...
func (this *lirc) setRcvCarrierRangeHz(value uint32) error {
	if err := this.lirc_ioctl(this.dev_in.Fd(), LIRC_SET_REC_CARRIER_RANGE, unsafe.Pointer(&value)); err != 0 {
...
func (this *lirc) setSendCarrierHz(value uint32) error {
	if err := this.lirc_ioctl(this.dev_in.Fd(), LIRC_SET_SEND_CARRIER, unsafe.Pointer(&value)); err != 0 {
...
func (this *lirc) setSendDutyCycle(value uint32) error {
	if err := this.lirc_ioctl(this.dev_in.Fd(), LIRC_SET_SEND_DUTY_CYCLE, unsafe.Pointer(&value)); err != 0 {
...
func (this *lirc) setRcvDutyCycle(value uint32) error {
	if err := this.lirc_ioctl(this.dev_in.Fd(), LIRC_SET_REC_DUTY_CYCLE, unsafe.Pointer(&value)); err != 0 {
...
func (this *lirc) setTransmitterMask(value uint32) error {
	if err := this.lirc_ioctl(this.dev_in.Fd(), LIRC_SET_TRANSMITTER_MASK, unsafe.Pointer(&value)); err != 0 {
...
func (this *lirc) setRcvTimeoutReports(value bool) error {
	...
	if err := this.lirc_ioctl(this.dev_in.Fd(), LIRC_SET_REC_TIMEOUT_REPORTS, unsafe.Pointer(&value2)); err != 0 {
...
func (this *lirc) setMeasureCarrierMode(value bool) error {
	value2 := bool2uint32(value)
	if err := this.lirc_ioctl(this.dev_in.Fd(), LIRC_SET_MEASURE_CARRIER_MODE, unsafe.Pointer(&value2)); err != 0 {
...
func (this *lirc) setWidebandReceiver(value bool) error {
	value2 := bool2uint32(value)
	if err := this.lirc_ioctl(this.dev_in.Fd(), LIRC_SET_WIDEBAND_RECEIVER, unsafe.Pointer(&value2)); err != 0 {
